...
import json
os.system("color 3")
os.system(f"title  Nguyễn Tuấn Anh")
kevin = "anh"
...
for i in range(3):
    ...
    j = 3
    if (pwd == kevin):
        print(" Đang Check Mật Khẩu \n")
        break
    else:
        time.sleep(5)
        print(" Sai rồi thằng ngu |Mật Khẩu là | anh \n")
        continue
time.sleep(2)
print("[V1] Welcome To  tuấn-anh ")
time.sleep(2)
nicknm = "user"
...
\033[35m                ║\033[32m                                               \033[35m║
\033[35m                ║\033[32m             ? - Help menu #NguyenTuanAnh        \033[35m║
\033[35m                ║\033[32m              methods - Shows methods          \033[35m║
\033[35m                ║\033[32m               exit - Exit             \033[35m║
...
\033[35m                ╔═══════════════════════════════════════════════╗
\033[35m                ║\033[32m- - - - - - - Tools By \033[36m@NguyenTuanAnh \033[35m- - - - - - -║
\033[35m                ║\033[32m- - - - - - -  \033[36mNguyenTuanAnh\033[35m - - - - - - -║
\033[35m                ║\033[32m  - - - Type \033[36m?\033[35m to see the Help Menu - - - - -  ║
\033[35m                ╚═══════════════════════════════════════════════╝
\033[35m                    ╔════════════════════════════════════════╗
\033[35m                    ║\033[32m- -Kết nối thành công \033[36m(ESTABILISHED)- -\033[35m║
\033[35m                    ╚════════════════════════════════════════╝
\033[35m                ╔═══════════════════════════════════════════════╗
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2; tuấn-anh. | number_powered: [{}] | Facebook: Dangtriofficial.3107 \x07".format (bots))
		sin = input("\033[32m[\033[35m{}\033[32m@tuấn-anh]\033[36m$ \033[96m".format(nicknm)).lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
		...
		if sinput == "cls":
			...
			os.system("cls" or "clear")
			print (help)
			print ("Mày bị ngu à . Thằng lồn hay để nguyễn tuấn anh chỉ hả thằng ngu")
			main()
